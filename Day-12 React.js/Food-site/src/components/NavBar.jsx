...
const NavBar = () => {
    ...
    <nav className="bg-white border-b w-full md:static md:text-sm md:border-none">
        ...
        {/* Hero Section Starts */}
        <section>
        <div class="container w-[90%] py-8 mx-auto">
        <div class="items-center lg:flex">
            <div class="w-full lg:w-1/2">
                <div class="lg:max-w-lg">
                    ...
                    <br />
                    <Link to="/card" class="w-full px-5 py-2 mt-6 text-sm tracking-wider text-white uppercase transition-colors duration-300 transform bg-blue-600 rounded-lg lg:w-auto hover:bg-blue-500 focus:outline-none focus:bg-blue-500">card</Link>
                </div>
            </div>
